...
import { LegacyLockMigrationBlockedError, MixedOwnershipProtocolError, } from "../../src/errors/concrete.js";
import { cleanupTempDir, makeTempDir } from "../helpers/temp-run-dir.js";
// ---------------------------------------------------------------------------
// Helpers
// ---------------------------------------------------------------------------
function setup(lockExists, dbExists) {
    const dir = makeTempDir();
    const runDir = join(dir, ".turnlock", "runs", "test-orch", "01HX00000000000000000000T1");
...
describe("assertOwnershipStorageCompatibility", () => {
    test("SQLite absent, .lock absent → no error (migration potentially allowed)", () => {
        ...
        try {
            assert.doesNotThrow(() => assertOwnershipStorageCompatibility({
                runDir: ctx.runDir,
...
//# sourceMappingURL=ownership-storage-compatibility.test.js.map