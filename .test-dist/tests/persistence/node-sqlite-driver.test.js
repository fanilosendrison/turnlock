...
describe("run-database", () => {
    ...
    test("WAL and synchronous pragmas are set", () => {
        ...
        try {
            ...
            const jm = runDb.connection.prepare("PRAGMA journal_mode").get();
            const sync = runDb.connection.prepare("PRAGMA synchronous").get();
...
//# sourceMappingURL=node-sqlite-driver.test.js.map