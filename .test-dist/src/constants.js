...
export const EXTERNAL_REQUEST_MANIFEST_VERSION = 1;
/**
 ...
 */
export const PENDING_INITIAL_DISPATCH_STATE_FIELD = "__turnlockInitialDispatchClaimV1";
/**
 ...
 */
export const PENDING_INITIAL_DISPATCH_VERSION_STATE_FIELD = "__turnlockInitialDispatchClaimV1Version";
export const PENDING_INITIAL_DISPATCH_VERSION = 1;
/**
 ...
 */
export const LEGACY_PENDING_INITIAL_DISPATCH_STATE_FIELD = "__turnlockPendingInitialDispatch";
export const LEGACY_PENDING_INITIAL_DISPATCH_VERSION_STATE_FIELD = "__turnlockPendingInitialDispatchVersion";
